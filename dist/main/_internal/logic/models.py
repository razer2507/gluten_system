...
class Producto:
    def __init__(self, nombre, precio_venta, precio_costo, categoria=None, id=None):
        self.id = id
        self.nombre = nombre          # TEXT NOT NULL
        self.precio_venta = precio_venta  # REAL NOT NULL
        self.precio_costo = precio_costo  # REAL NOT NULL
        self.categoria = categoria    # TEXT

    def a_tupla(self):
        """Utilitario para empaquetar los datos al usar INSERT en SQL"""
        return (self.nombre, self.precio_venta, self.precio_costo, self.categoria)
